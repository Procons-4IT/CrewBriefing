...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "ORDR" Or strTab = "INV1" Or strTab = "OWTR" Or strTab = "OITM") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddTables("Z_OCBS", "Crew Briefing Sheet Header", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddTables("Z_CBS1", "Crew Briefing Lines", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_CBS1", "Z_Dept", "Departure", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_CBS1", "Z_DepDate", "Departure Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_CBS1", "Z_ETD", "Estimated Depature Time", SAPbobsCOM.BoFieldTypes.db_Date, , , SAPbobsCOM.BoFldSubTypes.st_Time)
            AddFields("Z_CBS1", "Z_Arrival", "Arrival", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_CBS1", "Z_ArvDate", "Arrival Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_CBS1", "Z_ETA", "Expected Arrival Time", SAPbobsCOM.BoFieldTypes.db_Date, , , SAPbobsCOM.BoFldSubTypes.st_Time)
            AddFields("Z_CBS1", "Z_RefCode", "Reference Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("ORDR", "Z_CrewRef", "Crew Briefing Sheet Reference", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)

            AddTables("Z_OAIR", "Airport Master", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddFields("Z_OAIR", "Z_Code", "IATA  Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OAIR", "Z_Name", "IATA  Description", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OAIR", "Z_ICAO", "ICAO Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)


            AddTables("Z_AIR1", "Airport vendor mapping", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)
            AddFields("Z_AIR1", "Z_CardCode", "Vendor Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_AIR1", "Z_CardName", "Vendor Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
    ...
    Public Sub CreateUDO()
        Try
            AddUDO("Z_OAIR", "Airport-Vendor Mapping", "Z_OAIR", "DocEntry", "U_Z_Code", "Z_AIR1", SAPbobsCOM.BoUDOObjType.boud_Document)
